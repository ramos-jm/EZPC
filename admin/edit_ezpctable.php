...
<body>
    <div class="container">
        ...
        <form action="controller.php" method="POST" enctype="multipart/form-data">
            ...
            ?>
            <button type="submit" class="btn btn-primary" name="update_ezpctable">UPDATE PRODUCT</button>
        </form>
    </div>
</body>
</html>
...
<?php
    function getTableById($recno) {
        ...
        $sql = "SELECT * FROM ezpctable WHERE id='$recno'";
